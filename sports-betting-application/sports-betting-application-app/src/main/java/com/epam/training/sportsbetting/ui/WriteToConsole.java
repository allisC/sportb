...
//                                + outcomeOdd.getValidTo());
                        io.print(messageSource.getMessage("bet_on_the", new Object[] {index++, spE.getTitle(), bet.getDescription(), outcome.getValue(), outcomeOdd.getOddValue(), outcomeOdd.getValidFrom(), outcomeOdd.getValidTo() }, locale));
                    }
                }
            }
        }
...
//                        + wager.getOutcomeodd().getValidTo());
                io.print(messageSource.getMessage("the_winner_outcome", new Object[] {i, wager.getOutcomeodd().getOddValue(), wager.getOutcomeodd().getOddValue(), wager.getOutcomeodd().getValidFrom(), wager.getOutcomeodd().getValidTo()}, locale));
            }
        }
        printBalance(player);
    }
